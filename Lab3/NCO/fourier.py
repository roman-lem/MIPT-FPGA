...
plt.figure(1)
plt.plot(sin1[0:3000])
plt.plot(sin2[0:3000])
plt.plot(sin3[0:3000])
plt.savefig(f'/home/roman/Documents/fpga/Lab3/NCO/img/sin2.png')
...
plt.grid('on')
plt.savefig(f'/home/roman/Documents/fpga/Lab3/NCO/img/sin_step{step[0]}.png')
plt.show()
...
plt.ylabel('amlplitude, db')
plt.grid('on')
plt.savefig(f'/home/roman/Documents/fpga/Lab3/NCO/img/sin_step{step[1]}.png')
plt.show()
...
plt.ylabel('amlplitude, db')
plt.grid('on')
plt.savefig(f'/home/roman/Documents/fpga/Lab3/NCO/img/sin_step{step[2]}.png')
plt.show()
